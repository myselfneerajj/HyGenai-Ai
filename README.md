...
HyGenai-Ai is a project aimed at replicating the functionality of Gemini, powered by the Google Gemini API, using React and CSS.
...
```bash
git clone https://github.com/myselfneerajj/HyGenai-Ai
```
